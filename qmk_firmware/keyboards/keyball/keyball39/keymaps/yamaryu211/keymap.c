...
// // コンボキーの設定
  ...
  combo_t key_combos[] = {
      ...
      [1] = COMBO(combo_left_click2, KC_BTN1),
      [2] = COMBO(combo_right_click2, KC_BTN2),
      [3] = COMBO(combo_middle_click2, KC_BTN3),
      [4] = COMBO(combo_esc3, KC_ESC),
      //[11] = COMBO(combo_tab3, KC_TAB),
      [5] = COMBO(combo_left_click3, KC_BTN1),
      [6] = COMBO(combo_right_click3, KC_BTN2),
      [7] = COMBO(combo_middle_click3, KC_BTN3),
      // [12] = COMBO(combo_tab_alt, KC_TAB),
      [8] = COMBO(combo_tab2_alt, KC_TAB),
      [9] = COMBO(combo_tab3_alt, KC_TAB),
  };
#endif