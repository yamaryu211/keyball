...
// // コンボキーの設定
  ...
  combo_t key_combos[] = {
      [0] = COMBO(combo_esc2, KC_ESC),
      [1] = COMBO(combo_tab2_alt, KC_TAB),
      [2] = COMBO(combo_tab3_alt, KC_TAB),
      [3] = COMBO(combo_left_click2, KC_BTN1),
      [4] = COMBO(combo_right_click2, KC_BTN2),
      [5] = COMBO(combo_middle_click2, KC_BTN3),
      [6] = COMBO(combo_esc3, KC_ESC),
      [7] = COMBO(combo_left_click3, KC_BTN1),
      [8] = COMBO(combo_right_click3, KC_BTN2),
      [9] = COMBO(combo_middle_click3, KC_BTN3),
